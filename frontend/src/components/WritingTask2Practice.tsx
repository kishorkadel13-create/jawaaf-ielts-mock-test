...
const CATEGORIES = [
  { id: 'Opinion Essay', label: 'Opinion Essay', icon: <MessageSquare className="w-4 h-4" />, img3d: '/images/task2-assets/IMG_6538.PNG', color: 'bg-blue-600', hoverColor: 'hover:bg-blue-700', lightBg: 'bg-blue-50', text: 'text-blue-600', border: 'border-blue-100', iconColor: 'text-blue-500', desc: 'Write about a topic and give your personal opinion.' },
  { id: 'Discussion Essay', label: 'Discussion Essay', icon: <Users className="w-4 h-4" />, img3d: '/images/task2-assets/IMG_6539.PNG', color: 'bg-[#05162E]', hoverColor: 'hover:bg-[#1a365d]', lightBg: 'bg-red-50', text: 'text-red-500', border: 'border-red-100', iconColor: 'text-red-500', desc: 'Discuss both views and present a balanced argument.' },
  { id: 'Opinion-Discussion Essay', label: 'Opinion-Discussion Essay', icon: <Lightbulb className="w-4 h-4" />, img3d: '/images/task2-assets/IMG_6540.PNG', color: 'bg-[#05162E]', hoverColor: 'hover:bg-[#1a365d]', lightBg: 'bg-purple-50', text: 'text-purple-600', border: 'border-purple-100', iconColor: 'text-purple-500', desc: 'Discuss both views and give your own opinion.' },
  { id: 'Mixed Essay', label: 'Mixed Essay', icon: <Puzzle className="w-4 h-4" />, img3d: '/images/task2-assets/IMG_6541.PNG', color: 'bg-[#05162E]', hoverColor: 'hover:bg-[#1a365d]', lightBg: 'bg-orange-50', text: 'text-orange-500', border: 'border-orange-100', iconColor: 'text-orange-500', desc: 'A mix of question types to test your all-round writing skills.' },
];
